...
the option (not tested yet) :

  validates_vat_number :vat_number, :country_method => :my_method

where it is supposed that your model has a method nammed 'my_method' which
...
This plugin in released under MIT license by Aurélien Malisart
